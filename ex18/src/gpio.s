...
PORTJ_BIT               EQU     0000000100000000b ; bit 08 = Port J
...
main    MOV R2, #PORTN_BIT
	...
	LDR R1, [R0] ; leitura do estado anterior
        ...
        ORR R2, R4  ; habilita port N, F e J
...
wait	LDR R2, [R0] ; leitura do estado atual
	...
	STR R1, [R0] ; escrita do novo estado
        ...
        ;;;;;;PORTA J;;;;;;;
        MOV R2, #00000000b ; bit 0 e 1 para porta J (zero para entrada)
	...
	STR R1, [R0] ; escrita do novo estado
        ...
        MOV R2, #00000011b ; bit 0 e 1 para porta J
	...
	STR R1, [R0] ; escrita do novo estado
 	...
 	LDR R3, = GPIO_PORTF_DATA_R
        ...
        LDR R8, = GPIO_PORTJ_DATA_R
        
        MOV R6, #00000000b ; estado inicial
        
loop	
        LDR R9, [R8, #0x00C] ; acessa apenas PN0 e PN1
        MOV R10, #10
        CMP R9, R10
        BEQ soma
